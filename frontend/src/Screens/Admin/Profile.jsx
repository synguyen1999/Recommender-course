        ...
        <>
          <div>
            <p className="text-2xl font-semibold">
              Xin chào {data.firstName} {data.middleName} {data.lastName}👋
            </p>
            <div className="mt-3">
              <p className="text-lg font-normal mb-2">Id: {data.employeeId}</p>
              <p className="text-lg font-normal mb-2">
                Phone: +84 {data.phoneNumber}
              </p>
              <p className="text-lg font-normal mb-2">Email: {data.email}</p>
            </div>
            <button
              className={`${
